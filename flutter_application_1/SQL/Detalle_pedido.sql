...
-- Volcando estructura para tabla app1601.detalle_pedido
CREATE TABLE IF NOT EXISTS `detalle_pedido` (
  ...
  CONSTRAINT `FK__pedidos` FOREIGN KEY (`ID_Pedido`) REFERENCES `pedidos` (`ID_Pedido`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla app1601.detalle_pedido: ~0 rows (aproximadamente)
...
-- Volcando estructura para tabla app1601.repartidor
CREATE TABLE IF NOT EXISTS `repartidor` (
  `ID_Repartidor` int NOT NULL AUTO_INCREMENT,
  `ID_Usuarios` int NOT NULL DEFAULT '0',
  `Estado_Repartidor` int NOT NULL,
  PRIMARY KEY (`ID_Repartidor`),
  KEY `FK__usuarios` (`ID_Usuarios`),
  CONSTRAINT `FK__usuarios` FOREIGN KEY (`ID_Usuarios`) REFERENCES `usuarios` (`Id_Usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla app1601.repartidor: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla app1601.usuarios: ~2 rows (aproximadamente)
